...
var  subscribeImage = jQuery('#map').data('background-image');
...
if (subscribeImage) {  jQuery('#map').css({ 'background-image':'url(' + subscribeImage + ')' }); };
...
jQuery(document).ready(function($) {
	...
	$('.next-section .go-to-about').click(function() {
  	...
  	$('.next-section .go-to-map').click(function() {
